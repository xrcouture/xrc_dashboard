        ...
        <Row className='-hv cont-row'>
            ...
            <div className='box box-data w-100'>
                ...
                <Formik
                        ...
                        onSubmit={values => {
                            axios.post('http://localhost:5000/auth/form',values,{withCredentials:true}).then(res=>{
                                console.log(res)
                            })
                            console.log(values);
                            values.password.match( /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/) == null ? toast.error("Password Must Contain 8 Characters, 1 Uppercase, 1 Lowercase, 1 Number and 1 Special Case", {
                                ...
                                toastId:'passerror'
                              }):toast.success("Registered Successfully, check the email verify the email", {
                                position: toast.POSITION.TOP_RIGHT,
                                toastId:'passerror'
                              })
                              setTimeout(function() {
                        ...
                        isSubmitting,
                            ...
                            <Form>
                                ...
                                <Row>
                                    ...
                                    <ErrorMessage name="brandname" className='error' component="div" />
                                    </Col>
                                    <Col>
                                      <Label for="productname">
                                        ...
                                        <ErrorMessage name="productname" className='error' component="div" />
                                    </Col>
                                </Row>
                            ...
                            <Row>
                                ...
                                <Label for="brandlink">
                                    ...
                                    <ErrorMessage name="brandlink" className='error' component="div" />
                                </Col>
                            </Row>
                            <Label for="subdomain">
                              Sub Domain
                                ...
                                <div className="input-group-append">
                                    <span className="input-group-text" id="basic-addon2">.xrcouture.com</span>
                                </div>
                                </div>
                                 <ErrorMessage name="subdomain" className='error' component="div" />
                                 <label>
                                 <Field type="checkbox" className="form-check-input mr-2" name="toggle" />
                                   <span className='ml-2 position-relative'>
                                     By checking this box you confirm that you have read and agree to be bound by the Studio<a href='/terms'> Terms of Use and Privacy Policy.</a> 
                                    </span>
                                </label>
