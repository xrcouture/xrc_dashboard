...
class AdminNotification extends React.Component {
  ...
  handlecross = async (data) => {
    ...
    this.successalt('error', 'Complaint Is Reassigned')
    this.getAllDepartments()
    window.location.reload()
  }
          ...
          <DropdownItem tag="a" key={i}>
            ...
            <div className="notify-info">
              <span className="title">
                <h6>
                  <b>{u.complaint_type}</b> Complaint is resoved by Worker but{' '}
                  {u.student?.studentname} rejected.
                </h6>
                <Row>
                  <Col lg={9} sm={9} xs={9}>
                  ...
                  {u.submitted_by_admin === false && (
                    <Col sm={3} xs={3}>
                      <button
                        ...
                        onClick={(e) => this.ale('s', u, 'Is The Complaint Is Done')}
                      >
                      ...
                      <button
                        ...
                        onClick={(e) => this.ale('n', u, 'Is The Complaint Is Not Done Yet')}
                      >
