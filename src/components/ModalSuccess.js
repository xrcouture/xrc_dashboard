...
function ModalSuccess({children,text}) {
  ...
  return (
    <div>
      <Modal isOpen={modal} fade={true} toggle={toggle} size="sm" backdrop centered className="position-relative">
        ...
        <ModalBody className='position-relative mt-4 mb-2 text-center '> 
          {text}
            <p className='mt-2'>
          You Will be redirected in <span className='text-warning'>{time}s</span>
            </p>
        </ModalBody>
      </Modal>
    </div>
