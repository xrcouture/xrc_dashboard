  ...
  return (
    ...
    <div>
        <Row className='mt-4'>
            ...
            <input type="text" className="multiple-input"  placeholder='Asset Name' />
            </Col>
            <Col>
            <h1 className='multiple-label'>URL Link</h1>
            <input type="text" className="multiple-input"  placeholder='URL link of files' />
            </Col>
            <Col>
            <h1 className='multiple-label'>Manual Upload</h1>
            <label for="file-upload" class="custom-file-upload">
                <span><i class="fa fa-cloud-upload"></i> Upload .csv files</span>
            </label>    
            <input id="file-upload" type="file" onChange={e => handlefilechange(e)} />
            </Col>
        </Row>
        <div>
        ...
        {data.map((e,index) => (
        <Col className='d-flex flex-column platform-col col-sm-2' key={index}>
